    ...
    <tbody>
        {foreach from=$users item=$user}
            <tr>
             ...
             <td>{$user->email}</td>
             {if $user->rol == 0}
                <td> <button type="button" class="btn rounded-pill btn-sm" data-bs-toggle="modal" data-bs-target="#Modal{$user ->id}">
                ...
                <!-- Modal -->
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        ...
                        <p  class="text-center">¿Estás seguro que desea otorgarle al usuario <strong>{$user->username}</strong> opciones de administración?</p>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary"><a href="assignAsAdmin/{$user ->id}" class="text-decoration-none text-white">Si, estoy seguro</a></button>
                ...
                <!-- Modal -->
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        ...
                        <div class="modal-body">
                        <p  class="text-center">¿Estás seguro que desea eliminar los permisos de administración al usuario <strong>{$user->username}</strong></p>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary"><a href="deletePermit/{$user ->id}" class="text-decoration-none text-white">Si, estoy seguro</a></button>
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">CERRAR</button>
