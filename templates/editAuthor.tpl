...
<input type="button" class="btn btn-primary mb-3 btn-danger" value="Eliminar Autor" data-bs-toggle="modal" data-bs-target="#exampleModal">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit"  name="delete_button" class="btn btn-primary btn-danger">Eliminar Autor</button>
      </div>
    </div>
  </div>
</div>
